/**
 * @file Copy variant of the Hello World HTTP server.
 * @module server-copy
 * @description A duplicate of server.js that creates a simple HTTP server using
 * the Node.js built-in http module. The server listens on a configurable hostname
 * and port, responding to all incoming requests with a plain-text "Hello, World!" message.
 * @example
 * // Start the server:
 * // node "server - Copy.js"
